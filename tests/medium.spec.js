...
describe("Linked List Construction", () => {
  ...
  it("removeNodesWithValue", () => {
    ...
    expect(node6.prev).to.be(null);
    expect(node6.next).to.be(null);
    expect(node7.prev).to.be(null);
    expect(node7.next).to.be(null);
  });
  ...
  it("containsNodeWithValue", () => {
    expect(linkedList.containsNodeWithValue(2)).to.be(false);
    expect(linkedList.containsNodeWithValue(5)).to.be(true);
  });
});
